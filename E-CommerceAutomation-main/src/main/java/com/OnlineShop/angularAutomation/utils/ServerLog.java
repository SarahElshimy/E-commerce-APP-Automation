package com.OnlineShop.angularAutomation.utils;
...
public class ServerLog {
    ...
    public String getLocalLogFilePath(String testCaseName) throws IOException, SftpException, JSchException {
        ...
        try
        {
            ...
            fullLocalLogFileName = localLogFileDir + GeneralConstants.FILE_DELIMITER + localLogFileName;
    ...
    private static File fileWithDirectoryAssurance(String directory, String filename) {
        ...
        if (!dir.exists())
            dir.mkdirs();
        return new File(directory + GeneralConstants.FILE_DELIMITER + filename);
    }
...
//        }
        ...
        private Session setupSshSession() throws JSchException {
            ...
            String rmPassword = generalCofigsProps.getProperty(GeneralConstants.LOG_SERVER_PASSWORD);
